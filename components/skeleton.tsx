const Skeleton = () => {
  return (
    <div className="animate-pulse flex items-center rounded justify-between mt-4">
      <span className="rounded-lg p-2 bg-gray-100" onClick={() => {}}>
        <svg
      ...
      <div className="flex flex-col w-full ml-2 items-start justify-evenly">
        <div className="w-36 bg-gray-100 h-3 rounded-md "></div>

        <div className="w-36 bg-gray-100 h-3 mt-2 rounded-md "></div>
      </div>
    </div>
  );
};
